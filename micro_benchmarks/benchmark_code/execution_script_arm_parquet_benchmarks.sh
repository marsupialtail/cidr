...
SCRIPT_FILE_PATH="/Users/EA/Desktop/Quokka_Research/AWS_Instances_Micro_Benchmarks/io-micro-1.py"

# Output directory path
OUTPUT_DIRECTORY="/Users/EA/Desktop/Quokka_Research/AWS_Instances_Micro_Benchmarks/io_micro_dir/"  # Specify the desired directory path
...
for INSTANCE_TYPE in "${INSTANCE_TYPES[@]}"; do
    INSTANCE_ID=$(aws ec2 run-instances \
        --image-id "ami-0ccb9704048bd20a3" \
